...
python notebooks/train_main.py --exp E4 --seed 0
  --data_dir /path/to/tiny-imagenet-200 --out_dir ./outputs

## Reproduce ablations (E7 only)  
python notebooks/train_ablations.py --mode full --exp E7 ...
...
## Experiments logs
All JSON training logs are in logs/. Each file contains per-epoch
